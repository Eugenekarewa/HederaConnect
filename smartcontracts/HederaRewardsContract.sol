...
contract HederaConnectRewards is ERC20, Ownable, ReentrancyGuard {
    ...
    uint256 public LIKE_POINTS = 1;
    uint256 public SHARE_POINTS = 2;
    uint256 public COMMENT_POINTS = 1;
    uint256 public POINTS_TO_TOKEN_RATE = 100; // 100 points = 1 token
    ...
    constructor() ERC20("HederaConnectToken", "HCT") Ownable(msg.sender) {
